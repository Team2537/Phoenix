...
public class HumanInput {
	...
	public static Button vertRaiseButton = new JoystickButton(leftJoystick, Ports.VERT_RAISE_BUTTON);
	public static Button vertLowerButton = new JoystickButton(leftJoystick, Ports.VERT_LOWER_BUTTON);
