...
//	public static Button climbOverrideKeyTwo = new JoystickButton(rightJoystick, Ports.OVERRIDE_KEY_TWO);
	...
	public static Button vertLowerButton = new JoystickButton(xbox, 1);
	public static Button vertRaiseButton = new JoystickButton(xbox, 4);
	public static Button cuberFlipDownButton = new JoystickButton(xbox, 3);
	public static Button cuberFlipUpButton = new JoystickButton(xbox, 2);
//	public static Button climbOnButton = new JoystickButton(xbox, 5);
	public static Button climbOffButton = new JoystickButton(xbox, 6);
	public static Button climbOverrideKeyOne = new JoystickButton(xbox, 5);
	public static Button climbOverrideKeyTwo = new JoystickButton(xbox, 5);
