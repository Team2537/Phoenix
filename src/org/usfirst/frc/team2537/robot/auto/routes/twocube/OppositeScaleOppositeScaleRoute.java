...
public class OppositeScaleOppositeScaleRoute extends AutoRoute {
	@Override
	public void scheduleCommands() {
		addSequential(new OppositeScaleSecondCubeRoute());
		
		addSequential(new DriveStraightCommand(-30), 2);
