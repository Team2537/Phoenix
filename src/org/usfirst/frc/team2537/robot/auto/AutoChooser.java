...
public class AutoChooser extends SendableChooser<AutoChooserOption> {
	public AutoChooser() {
		...
		addObject("Left ELIMS (Scale)", AutoChooserOption.ELIMS_LEFT);
		addObject("Right ELIMS (Scale)", AutoChooserOption.ELIMS_RIGHT);
		addObject("Left Switch", AutoChooserOption.SWITCH_LEFT);
		addObject("Right Switch", AutoChooserOption.SWITCH_RIGHT);
